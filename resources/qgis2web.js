...
map.getView().fit([3712562.027312, 767236.604126, 13380071.179408, 6482924.479593], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Infraplan Projects</h2>';
        return titleElement;
    })(),
