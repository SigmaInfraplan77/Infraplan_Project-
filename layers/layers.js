...
lyr_GoogleTerrainHybrid_0.setVisible(true);lyr_India_1.setVisible(true);lyr_Architectural3DMapping_2.setVisible(true);lyr_CityDevelopmentPlanCitySanitationPlan_3.setVisible(true);lyr_SolarEnergy_4.setVisible(true);lyr_UndergroundDrainageScheme_5.setVisible(true);lyr_HydraulicModelStudies_6.setVisible(true);lyr_DrinkingWaterSupplyWorks_7.setVisible(true);
var layersList = [lyr_GoogleTerrainHybrid_0,lyr_India_1,lyr_Architectural3DMapping_2,lyr_CityDevelopmentPlanCitySanitationPlan_3,lyr_SolarEnergy_4,lyr_UndergroundDrainageScheme_5,lyr_HydraulicModelStudies_6,lyr_DrinkingWaterSupplyWorks_7];
lyr_India_1.set('fieldAliases', {'STATE': 'STATE', 'State_LGD': 'State_LGD', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
...
lyr_India_1.set('fieldImages', {'STATE': 'TextEdit', 'State_LGD': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
...
lyr_SolarEnergy_4.set('fieldImages', {'Name': 'TextEdit', 'Descri.': 'TextEdit', });
...
lyr_India_1.set('fieldLabels', {'STATE': 'no label', 'State_LGD': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
